...
switch getenv('COMPUTERNAME')
    case 'DESKTOP-MCS5K1H'
        ...
        obj = ptyLab; obj.export.exportPath = 'C:\Users\Lars Loetgering\Documents\fracPtyExport';
        obj.export.filePath = 'C:\Users\Lars Loetgering\Dropbox\CurrentProjects\ptychoWorkshop\data\lenspaper4\AVT camera (GX1920)';
    otherwise
        error('computername specified incorrectly')
        
end
cd(toolboxFolder);

% change the above depending on computer used for preprocessing
...
% wavelength
obj.wavelength = 450e-9;   % blue laser diode
% binning
obj.binningFactor = 2;
...
positionsFileName = dir([obj.export.filePath,'/Fermat_FOV1mm_step55um_202points.txt']);
