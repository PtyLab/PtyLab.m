...
obj.entrancePupilDiameter = 500e-6; % initial estimate of beam
...
% load('Ocalibrated'); obj.object = abs(Ocalibrated);
% load('Pcalibrated'); obj.probe = imresize(Pcalibrated,obj.Np * [1,1]);

obj.probe = abs(obj.probe);
%% manual params
...
obj.params.betaObject = 0.05;           % gradient step size object
...
obj.params.modulusEnforcedProbeSwitch = false;  % enforce emptruety beam
