...
%%
numCorruptedPixels = 5000;
Z = ones(obj.Nd, obj.Nd);
idx = randi(obj.Nd^2, [1 numCorruptedPixels]);
Z(idx) = 0;
figure(99), 
subplot(1,2,1)
imagesc(Z), axis image, colormap gray

obj.ptychogram = bsxfun(@times, obj.ptychogram, Z);
obj.params.W = ones(obj.Nd, 'single');
%% manual params
...
obj.params.intensityConstraint = 'LAD';% 'standard', 'exponential', fluctuation
