...
dataFolder = 'C:\Users\Lars Loetgering\Documents\fracPtyExport';
...
obj.params.npsm = 4;                    % number of probe/pupil state mixtures
...
obj.monitor.objectZoom = 1.5;                 % control object zoom in
...
obj.params.numIterations = 10;        % total number of iterations
obj.params.engine = 'mPIE';             % 'ePIE', 'mPIE', 'zPIE, 'e3PIE', 'm3PIE', 'pcPIE', 
obj = reconstruct(obj);

% lsq
obj.monitor.figureUpdateFrequency = 100; % frequency of reconstruction monitor 
obj.params.numIterations = 500;        % total number of iterations
obj.params.engine = 'lsqPIE';             % 'ePIE', 'mPIE', 'zPIE, 'e3PIE', 'm3PIE', 'pcPIE', 
obj = reconstruct(obj);
