...
switch getenv('COMPUTERNAME')
    case 'PHASESPACE'
        toolboxFolder = 'F:\Dropbox\Codes\FractionalOrderPtychographyMATLAB';
        dataFolder = 'F:\fracPtyExport';
    case and('', isunix)
        toolboxFolder = '/home/lars/Dropbox/Codes/FractionalOrderPtychographyMATLAB';
...
% [R, C] = GenerateFermatSpiral(100, 'c', 220); 
[R, C] = GenerateFermatSpiral(120, 'c', 1.2);
...
pause(0.5)
userConfig = struct('xy',xy,'numIter',4e4, 'popSize', 40); 
