...
% https://figshare.com/articles/dataset/Untitled_Item/21687644
...
% add toolbox folders
directory_info = dir();
toolboxFolder = erase( directory_info(1).folder, 'tutorials\4_regularization');
...
obj.export.filePath = 'C:\Users\Lars Loetgering\Documents\fracPtyRaw\ptyLab_data\SiemensStar_dp_processed.hdf5';
...
obj.probe = h5read(obj.export.filePath,'/probe');
% obj.wavelength = h5read(obj.export.filePath,'/wavelength'); %% !!! send
% > contact wilhelm
obj.wavelength = 13.5e-9;
obj.numFrames = size(obj.ptychogram,3);
toc

%% switch orientation

% obj.ptychogram = permute(obj.ptychogram, [2, 1, 3]);
